    ...
    <div class="instances_container">
      ...
      <div class="columns">
        <div class="column drafts_filters">
          ...
          <p @click="(!loading) ? filterActive = 'title' : ''"
            :style="(filterActive === 'title') ? 'font-weight:600' : ''">title</p>
          <p @click="(!loading) ? filterActive = 'date' : ''"
            :style="(filterActive === 'date') ? 'font-weight:600' : ''">date</p>
          <p @click="(!loading) ? filterActive = 'type' : ''"
            :style="(filterActive === 'type') ? 'font-weight:600' : ''">type</p>
        </div>
        <div class="column is-two-thirds">
          ...
          <div class="draft_list" id="draft_list_loading" style="position:relative"
