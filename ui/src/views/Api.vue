<template>
  <div class="home">
    <div v-if="!loading">
      <h1 class="title is-3">Fast access to your data</h1>
      Each data is a NFT, this means you can read it directly from the
      blockchain and IPFS or, if you need a faster access, you can use your
      personal endpoints, you have one enpoint for each instance:<br /><br />
      <div v-for="(instance, index) in instances" v-bind:key="instance">
        Instance #{{ index + 1 }}:
        <a target="_blank" :href="'https://api.mego.cx/contents/' + instance"
