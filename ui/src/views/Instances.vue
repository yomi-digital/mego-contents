  ...
  <div id="instances">
    <div class="instances_container">
      <div class="instances_header">
        ...
        <!-- <b-button type="button button-dark is-light ml-auto mr-0 mt-1" style="background:#111!important;color:white!important" class="button">
          <font-awesome-icon icon="fa-solid fa-plus" style="font-size:24px"/>
        </b-button> -->
      </div>
        ...
        <div class="instance" v-for="instance in Object.keys(datatypes)" :key="instance">
          <div class="instance_left">
            <h3 class="my-2"><span style="font-weight:bold;color:black;font-size:22px;">{{names[instance]}}</span><i
                v-if="Object.keys(datatypes[instance]).length > 0" style="font-size:15px; margin:0 1rem">Deployed at: <a
                  :href="'https://etherscan.io/address/'+instance" target="_blank"
                  style="color:black;text-decoration:underline">{{instance}}</a></i><i v-else
                style="font-size:15px; margin:0 1rem">Not deployed yet</i></h3>
